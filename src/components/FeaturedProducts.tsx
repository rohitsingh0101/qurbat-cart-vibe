    ...
    <section className="py-20 bg-muted/30">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <h2 className="font-display text-4xl font-bold text-luxury-maroon mb-4">
            Featured Products
          </h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Handpicked favorites that our customers absolutely love. These trending pieces combine traditional craftsmanship with modern appeal.
          </p>
        </div>
